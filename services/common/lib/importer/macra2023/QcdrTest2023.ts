...
let facts: EncounterFormFacts2023[] = [];

let abg42 = <EncounterFormFacts2023>{
    _testId: 'ABG42',
    enctrFormAudVer: 1,
...
let aqi62 = <EncounterFormFacts2023>{
    _testId: 'AQI62',
    enctrFormAudVer: 1,
    hasAnesthesiaProvider: true,
    hasDateOfService: true,
...
let aqi68 = <EncounterFormFacts2023>{
    _testId: 'AQI66',
    enctrFormAudVer: 1,
    hasAnesthesiaProvider: true,
    hasDateOfService: true,
...
let qid404 = <EncounterFormFacts2023>{
    _testId: 'QID404',
    enctrFormAudVer: 1,
    hasAnesthesiaProvider: true,
    hasDateOfService: true,
...
/*
let qid424 = <EncounterFormFacts2023>{
    _testId: 'QID424',
    enctrFormAudVer: 1,
    hasAnesthesiaProvider: true,
    hasDateOfService: true,
    ...
    nerveBlockInd: false,
    allCptCodes: ['01850'],
    anesthesiaStartDateTime: '2023-01-01 12:14:00',
    anesthesiaEndDateTime: '2023-01-01 13:22:00',
...
let qid430 = <EncounterFormFacts2023>{
    _testId: 'QID430',
    enctrFormAudVer: 1,
    hasAnesthesiaProvider: true,
    hasDateOfService: true,
...
let qid477 = <EncounterFormFacts2023>{
    _testId: 'QID477',
    enctrFormAudVer: 1,
    hasAnesthesiaProvider: true,
    hasDateOfService: true,
...
//}));
let factsEval = new EncounterFormFactsEval2023();
