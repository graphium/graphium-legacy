...
module.exports = (function () {
    ...
    function EncounterFormMacraEval2018(serviceConfig, facilityId, encounterFormId) {
    ...
    EncounterFormMacraEval2018.prototype.getFormFacts = function () {
        ...
        return this.serviceUtils.getSearchResultsBySearchName('system.abgEncounterFormList2018', searchParameters);
    }

    EncounterFormMacraEval2018.prototype.getFormFactsForPendingFormsFromDb = function(onlyPendingForms) {
        return PqrsAnalyticsDAO.get2018QcdrFormFacts(this.serviceConfig.orgInternalName, this.facilityId, onlyPendingForms);
    }

    EncounterFormMacraEval2018.prototype.evaluateAllPendingForms = function(includeFactsInResults) {
        var _this = this;
    ...
    EncounterFormMacraEval2018.prototype.evaluateAllFormsForDateRange = function(includeFactsInResults) {
        var _this = this;
    ...
    EncounterFormMacraEval2018.prototype.getFormFactsForDateRange = function(startDate, endDate) {
        var searchParameters = [];
        searchParameters.push({
            parameterName: 'fac_id',
            parameterValue: parseInt(this.facilityId)
    ...
    EncounterFormMacraEval2018.prototype.evaluateDateRange = function(startDate, endDate, includeFactsInResults) {
        var _this = this;
    ...
    EncounterFormMacraEval2018.prototype.evaluateForm = function (includeFactsInResults) {
        var _this = this;
...
*/
    ...
    function executeRules(facts) {
        var qcdrVersion = 'ABG.2018.1.1';
        /**
         * Author: M.Oldham
         * Update History:
         *   Date       Name     Version      Changes
         *   ---------- -------- ------------ ---------------------------------------------------------------------
         *   01/05/2018 M.Oldham ABG.2018.1.0 Updated preliminary 2018 logic. All 2017 logic retained with the 
         *                                    exception of ABG5being removed.
         *                                    NOTE: ABG21 could change (or be removed) once measures are finalized,
         *                                          but for now the logc remains the same. 
         *   01/23/2018 M.Oldham ABG.2018.1.1 Expand pain score evaluation logic in ABG7 to handle alternate pain
         ...
         *     "admissible": false,
         *     "missing": ["field1,field3"],
         *     "qcdrVersion": "ABG.2018.1.0"
         * }
         * 
         * qcdr_missing_data_count: 2
         * qcdr_eval_dttm: "2018-01-04T15:05:18.064Z"
         * qcdr_eval_enctr_form_ver: 11
         *}
         * 
         */
        ...
        var abgPhaseMeasures = ['ABG14'];
        var abgQcdrMeasures = ['ABG7', 'ABG21', 'ABG28', 'ABG29', 'ABG30', 'ABG31'];
        var complicationsList = ['misc_eye_inj'];
    ...
    return EncounterFormMacraEval2018;
})();
